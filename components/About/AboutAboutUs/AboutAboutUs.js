...
const image = 'https://i.ibb.co/K7fSFM5/Logo-1.png';
const image2 = 'https://i.ibb.co/sCKHvfw/Logo-2.png';
const image3 = 'https://i.ibb.co/ZWFBGtp/Logo-3.png';
const image4 = 'https://i.ibb.co/5nMFRcj/Logo-4.png';
const image5 = 'https://i.ibb.co/9s9mhPQ/Logo-5.png';
const image6 = 'https://i.ibb.co/7z5sWqd/Logo-6.png';
const AboutAboutUs = () => {
  return (
    <div className='w-4/5 mx-auto'>
      ...
      <div className='mt-[112px] border-b '>
        <p className='text-[14px] font-bold text-primary text-center'>Trusted By 1k+ Company Arround The World!</p>
        <div className='flex justify-between items-center flex-wrap  mt-12 pb-2'>
          <img src={image} alt="" />
          <img src={image2} alt="" />
          <img src={image3} alt="" />
          <img src={image4} alt="" />
