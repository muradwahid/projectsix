...
const AboutTestimonial = () => {
  return (
    <div className='w-4/5 mx-auto my-28'>
      <p className='uppercase text-[14px] tracking-[-0.5px] font-bold text-center text-primary'>Testimonials</p>
      <h2 className='text-center mt-3 tracking-[-0.03em]'>Our students says about us</h2>
