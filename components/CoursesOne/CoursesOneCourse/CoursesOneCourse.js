...
const image6 = 'https://i.ibb.co/02fhnwy/Img-9.png';
const image7 = 'https://i.ibb.co/sbnXMLK/Img-10.png';
const image8 = 'https://i.ibb.co/xqk3QhY/Img-11.png';
    ...
    <div className="w-4/5 mx-auto my-16">
      <div className="flex items-center justify-between gap-5 flex-wrap">
        <div className="flex gap-3 items-center">
          <div className="bg-primary text-[24px] text-white p-2 rounded-md">
            <TbCategory2/>
          </div>
          <div className="bg-[#F5F0EE] text-[24px] p-2 rounded-md">
            <BsListUl/>
          </div>
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-7'>
              ...
              <div className='px-6'>
                ...
                <div className='pb-8'>
                  ...
                  <div className='flex justify-between items-center'>
                    <div className='flex gap-3'>
                      <div>
                        <img src='https://i.ibb.co/h979LtC/Ellipse-29.png' alt="" />
                      </div>
                      <div>
                        <p className='font-bold'>Esther Howard</p>
                        <div className='flex'>
        ...
        <div className='popular-card relative courses-card'>
          <div className='bg-white relative rounded-[18px] overflow-hidden poular-main-card'>
            <div className=''>
              <img className='w-full' src='https://i.ibb.co/sbnXMLK/Img-10.png' alt="" />
              <div className='absolute top-5 left-5 bg-white text-[16px] p-2 rounded-full'>
                <BsBookmarkDash />
              </div>
            </div>
              ...
              <div className='px-6'>
                ...
                <div className='pb-8'>
                  ...
                  <div className='flex justify-between items-center'>
                    <div className='flex gap-3'>
                      <div>
                        <img src='https://i.ibb.co/vXSqG7s/Ellipse-29-1.png' alt="" />
                      </div>
                      <div>
        ...
        <div className='popular-card relative courses-card'>
          <div className='bg-white relative rounded-[18px] overflow-hidden poular-main-card'>
            <div className=''>
              <img className='w-full' src='https://i.ibb.co/xqk3QhY/Img-11.png' alt="" />
              <div className='absolute top-5 left-5 bg-white text-[16px] p-2 rounded-full'>
                <BsBookmarkDash />
              </div>
            </div>
              ...
              <div className='px-6'>
                ...
                <div className='pb-8'>
                  ...
                  <div className='flex justify-between items-center'>
                    <div className='flex gap-3'>
                      <div>
                        <img src='https://i.ibb.co/1sBsh3F/Ellipse-29-2.png' alt="" />
                      </div>
                      <div>
...
export default CoursesOneCourse;